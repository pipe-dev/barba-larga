...
const initialFormState = { message: null, errors: {}, success: false };
...
function AddCustomerForm({onFormSubmit}: {onFormSubmit: () => void}) {
    const [state, formAction] = useActionState(addCustomer, {success: false, message: null, errors: {}});
    const {toast} = useToast();
    const formRef = React.useRef<HTMLFormElement>(null);
...
const initialProductFormState = { message: null, errors: {}, success: false };
