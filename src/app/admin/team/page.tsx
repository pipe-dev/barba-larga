...
import { z } from "zod";
import { ArrowLeft, Loader2, PlusCircle, Trash2, Pencil, Users2 } from 'lucide-react';
...
const initialNewTeamMemberFormState = { message: null, errors: {}, success: false };
  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        <FormField control={form.control} name="email" render={({ field }) => ( <FormItem> <FormLabel>Email (para notificaciones)</FormLabel> <FormControl><Input {...field} name="email" type="email" placeholder="ejemplo@email.com"/></FormControl> <FormMessage /> </FormItem> )} />
...
const initialTeamMemberFormState = { message: null, errors: {}, success: false };
